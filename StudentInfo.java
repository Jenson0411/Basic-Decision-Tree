...
public class StudentInfo {
	...
	public static void display() {
		...
		System.out.println("************************************************************");
		System.out.println("*Student Name: Jenson Wu                                   *");
		System.out.println("*Student Number: 300166874                                 *");
		System.out.println("*Course Section: ITI 1121 C                                *");
		System.out.println("*Lab Section: C-01                                         *");
		System.out.println("************************************************************");
		System.out.println();
